...
{
    ROS_INFO("DriveToTarget service request received - linear_x: %.3f, angular_z: %.3f", req.linear_x, req.angular_z);
    ...
    res.msg_feedback = "velocities are set to: linear_x: " + std::to_string(motor_command.linear.x) + ", angular_z: " + std::to_string(motor_command.angular.z);
